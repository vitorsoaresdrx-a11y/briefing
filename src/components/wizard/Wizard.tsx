  ...
  if (status === "notfound") {
    return (
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center gap-4 px-6 py-24">
        <h1 className="font-display text-5xl uppercase leading-[1.05]">Link inválido</h1>
  ...
  if (status === "error" || !screen) {
    return (
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center gap-6 px-6 py-24">
        <h1 className="font-display text-5xl uppercase leading-[1.05]">Sem conexão</h1>
          ...
          >
            {view === "review" ? (
              ...
              >
                ...
                <h1 ref={titleRef} tabIndex={-1} className="mt-4 font-display text-5xl uppercase leading-[1.05] tracking-[-0.01em] focus:outline-none sm:text-6xl">
                  {screen.step.title}
                </h1>
