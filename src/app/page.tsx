      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 sm:px-10">
        <section className="grid gap-12 pb-24 pt-10 sm:pt-16 lg:grid-cols-[1.6fr_1fr] lg:gap-16">
          <Reveal>
            ...
            <h1 className="mt-6 font-display text-[13vw] uppercase leading-[0.9] tracking-[-0.01em] sm:text-7xl lg:text-8xl">
        ...
        <section id="como-funciona" className="scroll-mt-8 border-t border-line py-16 sm:py-20">
          <Reveal>
            ...
            <h2 className="mt-4 font-display text-5xl uppercase leading-[0.9] tracking-[-0.01em] sm:text-6xl">
        ...
        <section className="border-t border-line py-16 sm:py-24">
          <Reveal>
            <h2 className="max-w-3xl font-display text-5xl uppercase leading-[0.9] tracking-[-0.01em] sm:text-7xl">
